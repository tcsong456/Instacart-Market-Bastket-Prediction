...
from src.ingestion.create_product_history_data import parse_seq, filtered_orders, build_each_product_in_order_history, SELECTED_COLUMNS
...
def test_build_each_product_in_order_history(spark, tmp_path):
    ...
    orders = spark.createDataFrame(
        [
            {
                'user_id': 10,
                'target_eval_set': 'train'
            },
            {
                'user_id': 20,
                'target_eval_set': 'test'
            }
        ]
    )
    ...
    expected_df = spark.createDataFrame(
        [
            Row(product_id=0, label=0, is_ordered_history='0 1 0', position_in_order_history='0 1 0', **common_cols_1),
            Row(product_id=1, label=0, is_ordered_history='1 0 1', position_in_order_history='1 0 3', **common_cols_1),
            Row(product_id=2, label=0, is_ordered_history='1 0 0', position_in_order_history='2 0 0', **common_cols_1),
            Row(product_id=3, label=0, is_ordered_history='1 0 0', position_in_order_history='3 0 0', **common_cols_1),
            Row(product_id=5, label=1, is_ordered_history='0 0 1', position_in_order_history='0 0 1', **common_cols_1),
            Row(product_id=10, label=0, is_ordered_history='0 1 0', position_in_order_history='0 2 0', **common_cols_1),
            Row(product_id=12, label=0, is_ordered_history='0 0 1', position_in_order_history='0 0 4', **common_cols_1),
            Row(product_id=323, label=0, is_ordered_history='0 0 1', position_in_order_history='0 0 2', **common_cols_1),

            Row(product_id=5, label=-1, is_ordered_history='1 0 0', position_in_order_history='2 0 0', **common_cols_2),
            Row(product_id=11, label=-1, is_ordered_history='1 0 1', position_in_order_history='1 0 5', **common_cols_2),
            Row(product_id=12, label=-1, is_ordered_history='0 0 1', position_in_order_history='0 0 1', **common_cols_2),
            Row(product_id=20, label=-1, is_ordered_history='0 0 1', position_in_order_history='0 0 2', **common_cols_2),
            Row(product_id=23, label=-1, is_ordered_history='1 1 0', position_in_order_history='3 2 0', **common_cols_2),
            Row(product_id=300, label=-1, is_ordered_history='0 1 1', position_in_order_history='0 1 4', **common_cols_2),
            Row(product_id=1000, label=-1, is_ordered_history='0 0 1', position_in_order_history='0 0 3', **common_cols_2),
        ]
    )
