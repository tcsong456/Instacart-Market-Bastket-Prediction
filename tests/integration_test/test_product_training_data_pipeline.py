    ...
    product_history_data = spark.createDataFrame(
        [
            Row(
                ...
                order_dows="0 1 2 3 4 5 6 6 2 4",
            ...
            Row(
                ...
                order_dows="0 1 2 3 4 5 6 6 2 4 0 2",
    ...
    expected_df = spark.createDataFrame(
        [
            ...
            Row(
                ...
                order_dows=[0, 1, 2, 3, 0, 0, 0, 0, 0, 0],
                order_hours=[5, 6, 8, 10, 0, 0, 0, 0, 0, 0],
                days_since_prior_orders=[-1, 10, 5, 20, 0, 0, 0, 0, 0, 0],
                order_numbers=[1, 2, 3, 4, 0, 0, 0, 0, 0, 0],
